...
# Convert "set_up" qmd file to a plain R script
knitr::purl("set_up_v3.qmd", documentation = 2, output = "unified_script/set_up_v3.R")
# Specify farm_id
farm_id<-"bc1_v2" #CAT-ESP-6-1" #bl1_v3_mod" #bc1_v2
# Source the setup script
source("unified_script/set_up_v3.R")
```
