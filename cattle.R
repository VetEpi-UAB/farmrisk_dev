...
script_date <- '2026-01-14 16:29:24.059134'
repo <- 'https://github.com/VetEpi-UAB/farmrisk_dev'
last_commit <- '0d8aeb56cb66148728d04f907018de590ce0942c'
commit_date <- 1768382528
unify_info <- 'cattle.R unified from: mov_v4.qmd, farm_visits_v2.qmd, farm_neighbours_v2.qmd, farm_wildlife_v2.qmd, output_v4.qmd'
if(exists('mov')){
#' ---
...
if(sum(!is.na(bsg$visit_type_1),!is.na(bsg$visit_veh_type_1))>0){
#' ---
